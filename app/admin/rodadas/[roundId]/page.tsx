...
export default async function AdminRoundDetailPage({
  ...
  try {
            ...
            <div className="admin-stats">
              ...
              <div className="admin-stat">
                ...
                <small className="muted">
                  {detail.matches.filter((match) => match.state !== "scheduled").length} com pontos computados
                </small>
              </div>
              <div className="admin-stat">
    ...
    return (
      <AdminShell
        title="Rodada"
        subtitle="Nao foi possivel consultar os dados persistidos desta rodada."
        activePath="/admin/dashboard"
      >
        <section className="card">
          <div className="card__header">
            <div>
              ...
              <span className="muted">Nao foi possivel carregar os detalhes administrativos.</span>
            </div>
          </div>
