...
- [ ] T010 Define source-of-truth boundaries and synchronization state model
- [ ] T011 [P] Isolate standings, tie-break, and bracket rules into dedicated domain modules
- [ ] T012 [P] Protect external API secrets and admin-only operational actions
...
- [ ] T015 [P] [US1] Business-rule test for standings, tie-breakers, or sync-state handling
